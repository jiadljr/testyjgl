        	...
        	<div class="accordion" fillSpace="sidebar">
           		<div class="accordionContent">
              		<ul id="a" class="tree treeFolder collapse">
                		<li class="tree_list" style="display: block;"><a autobypy="bz" dataType="topmenu" childMneu="bzmenus" keyboard="A" style="color:#183152" id="openTree">科室名称</a>
...
$(function(){
	...
	function queryType(id,name){
		var url = getPath()+"/selectDeptParentId.do";
		$.ajax({
			url:url,
			data:{'id':id},
			dataType:'json',
	...
	function sureAssets() {
		...
		$('#deptId',parent.document).val(arrayId);
		$('#deptName',parent.document).val(arrayName);
		//alert(array);
