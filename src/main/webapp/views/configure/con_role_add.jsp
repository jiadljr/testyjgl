...
<body>
		<div class="mRight">
			...
			<div class="mRbot mNewRbot">
				<div class="mRwell">
					<div class="mRwell-tit">添加角色信息</div>
						...
						<div class="mRwell-container">
							<div class="mRwell-con-center">
								<div class="form-group">
									...
									<div class="col-sm-9"><input type="text" id="roleCode" name="roleCode" class="form-control error_null" data-message="角色编号不得为空！" value=""></div>
								</div>
								<div class="form-group">
									<label for="role_name" class="col-sm-3">角色名称<span style="color:red;font-size:16px;">*</span>：</label>
									<div class="col-sm-9"><input type="text" id="roleName" name="roleName" class="form-control error_null" data-message="角色名称不得为空！" value=""></div>
								</div>
								<div class="form-group">
									<label for="role_remark" class="col-sm-3">角色描述<span style="color:red;font-size:16px;">*</span>：</label>
									<div class="col-sm-9"><input type="text" id="roleRemark" name="roleRemark" class="form-control error_null" data-message="角色描述不得为空！" value=""></div>
								</div>
								<div class="btnlist">
