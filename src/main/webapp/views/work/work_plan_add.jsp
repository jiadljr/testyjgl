	...
	<div class="mRight">
		...
		<div class="addBox">
			...
			<div class="work_group">
				<label >标题*：</label>
				<input type="text" id="planHeadline" name="planHeadline" class="inputTxt error_null" />
			</div>
			<div class="work_group">
				<label >类型：</label>
				<input type="radio" id="workType" name="workType" checked value="1">个人计划
	       	    <input type="radio" id="workType" name="workType" value="2">部门计划<br>
			</div>
			...
			<div class="work_group">
				<label>提醒：</label>
				  <input type="radio" id="remind" name="remind" value="1" checked />不提醒
				  <input type="radio" id="remind" name="remind" value="2">每天
				  <input type="radio" id="remind" name="remind" value="3">每周
				  <input type="radio" id="remind" name="remind" value="4">每月
				  <input type="radio" id="remind" name="remind" value="5">自定义
			</div>
			<div class="work_group">
				<label></label>
				...
				<input type="text" id="remindAuto" class="inputTxt" name="remindTime"   style="width: 100px">
			...
			<div class="work_group radioBox" style="display:none">
				<label> 负责人*：</label>
				<select id="principal" name="principal" class="error_null">
		...
		<div id="planDiv" class="work_group radioBox" style="height:150px; display:none;" >
		 	...
		 	<div class="work_group">
				<label>推送：</label>
				<input type="checkbox" id="check" style="float:left; margin-top:14px;" />
		  ...
		  function delPag(boxId,selId){
			...
			function selPag(boxId,selId){
			  $(boxId).click(function(e){
					...
					$(selId).show();
					$(selId).click();
					if($(selId+" option").length == $(selId+" .bulingbuling").length){
						$(selId).hide()
					}else{
						$(selId).show()
					}
