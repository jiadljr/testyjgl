...
<div class="itemList">
	<label>标题*：</label>
	<input type="text" id="reportName" name="reportName"  class="inputTxt error_null" />
</div>
<div class="itemList">
	<label>汇报类型*：</label>
	<select id="reportType" name="reportType" class="error_null">
 		   <option value="1">自定义</option>
 		   <option value="2">日报</option>
 		   <option value="3">周报</option>
...
<div class="itemList" style="height:150px;">
	<label>内容*：</label>
	<textarea id="reportContent" name="reportContent" class="error_null"></textarea> 
</div>
	<div class="proRight">
...
$(function(){
	...
	$("#sub").click(function(){
		...
		$.ajax({
			type:"post",
			url:getPath()+"/addSubWorkReport.do",
			data:formData,
			traditional: true,
			async: false,
			processData : false,
