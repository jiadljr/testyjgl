...
<head>
	...
	<style>
	body{ overflow:auto;}
	 .event_look{ width: 640px; margin:0 auto 20px auto; padding-bottom:20px;}
    ...
    <div class="event_look_inner" id="apply_mes">
        ...
        <table class="table  table-bordered">
            ...
            <tr>
                ...
                <td colspan="3">${eventInfoOne.eventName }</td>

            </tr>
            <tr>
                <td class="table_tit">事件描述</td>
                <td  colspan="3" class="nostr">${eventInfoOne.eventDesc }</td>
