	...
	<div class="mRight">
		...
		<div class="mQuery-2" >
			<form action="" role="form" class="form-horizontal" method="post">
				...
				<input type="hidden" id = "projCode" value="${projCode }"/>
				...
				<div class="form-group col-sm-2" style="margin-left: 0px">
					<label for="eventPer" class="col-sm-6">任务负责人:</label>
					<div class="col-sm-6">
				...
				<div class="form-group col-sm-3" style="margin-left: 0px; text-align:right; position:absolute;right:10px; top:35px;">
					<a class="btn btn-primary" href="#" onclick="acancel()">返回</a>
					...
					<a class="btn btn_green" href="#" id="export"  onclick="exportTaskCotrol()" style="border:none; height:27px;" >导出</a>
				</div>
			</form>
		</div>
